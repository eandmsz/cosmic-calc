...
pub use errors::{
    CalcError, ERR_ACOS_DOMAIN, ERR_ASIN_DOMAIN, ERR_COTANGENT, ERR_DIVISION_BY_ZERO,
    ERR_INDETERMINATE, ERR_LOG_BASE_ONE, ERR_NEGATIVE_EVEN_ROOT, ERR_NEGATIVE_LOG, ERR_OVERFLOW,
